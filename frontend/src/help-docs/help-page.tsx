...
const shapeDocuments: ShapeDoc[] = [
    ...
    },
    {
        ...
        icon: '🎨',
        category: 'Design',
        description: 'Canva-style design documents: pages & size presets, templates, Magic Resize, brand kit, elements library, text effects, AI assists, version history, offline PWA',
        keywords: 'canva design document page size preset instagram post story poster flyer business card template search fits badge my templates brand kit font pairing elements panel frames photo frame heart star hexagon stock photos wikimedia orientation landscape portrait square drag drop crop aspect ratio 1:1 4:5 16:9 9:16 lock text effect shadow lift hollow splice outline echo neon glitch background highlight curved set as page background detach image background jpg jpeg png export current page only magic write ai image generate remove background thumbnail indexeddb magic resize repurpose format magic edit inpaint magic expand outpaint extend photo ai design generate brief version history snapshot restore recents grid open drawing bullet numbered list rich text pwa install offline service worker app',
