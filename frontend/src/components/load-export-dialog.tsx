                        ...
                        <Show when={activeTab() === 'save'}>
                            <div class="options-grid horizontal">
                                ...
                                <Show when={features.enableRocketExport}>
                                    <div class="option-card compact" onClick={props.onExportRocket}>
                                        <div class="option-icon image">
                                            <Rocket size={24} />
                                        </div>
                                        <div class="option-info">
                                            <h4>Export to Rocket</h4>
                                            <p>Generate Rocket Backend import schema from entities</p>
                                        </div>
                                        <button class="action-trigger secondary">Export Rocket</button>
                                    </div>
                                    <div class="option-card compact" onClick={props.onDeployRocket}>
                                        <div class="option-icon cloud">
                                            <Rocket size={24} />
                                        </div>
                                        <div class="option-info">
                                            <h4>Deploy to Rocket</h4>
                                            <p>Export and push schema directly to your Rocket instance</p>
                                        </div>
                                        <button class="action-trigger secondary">Deploy</button>
                                    </div>
                                </Show>
