...
const SHORTCUT_DATA: ShortcutCategory[] = [
    ...
    },
    {
        ...
        shortcuts: [
            ...
            { key: 'editor-stretchOneSide', keys: 'Drag a side handle' },
            ...
            { key: 'editor-distortOneCorner', keys: 'Ctrl+Drag a corner handle' },
            { key: 'editor-shearSlant', keys: 'Ctrl+Drag a side handle' },
