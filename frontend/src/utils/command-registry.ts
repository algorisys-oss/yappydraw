...
export const getCommands = (): Command[] => {
    const commands: Command[] = [
        ...
        { id: 'tool-pathfinder-bar', label: 'Pathfinder Strip: Show / Hide', category: 'Tools', action: () => togglePathfinderBar() },
        { id: 'width-profile-uniform', label: 'Width Profile: Uniform', category: 'Tools', action: () => setWidthProfilePreset([...store.selection], 'uniform') },
        { id: 'width-profile-bulge', label: 'Width Profile: Bulge', category: 'Tools', action: () => setWidthProfilePreset([...store.selection], 'bulge') },
        { id: 'width-profile-waist', label: 'Width Profile: Waist', category: 'Tools', action: () => setWidthProfilePreset([...store.selection], 'waist') },
        { id: 'width-profile-taper-out', label: 'Width Profile: Taper out', category: 'Tools', action: () => setWidthProfilePreset([...store.selection], 'taper-out') },
        { id: 'width-profile-taper-in', label: 'Width Profile: Taper in', category: 'Tools', action: () => setWidthProfilePreset([...store.selection], 'taper-in') },
        { id: 'width-profile-chisel', label: 'Width Profile: Chisel', category: 'Tools', action: () => setWidthProfilePreset([...store.selection], 'chisel') },
        { id: 'width-profile-oval', label: 'Width Profile: Oval', category: 'Tools', action: () => setWidthProfilePreset([...store.selection], 'oval') },
