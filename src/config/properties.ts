...
export const properties: PropertyConfig[] = [
...

    {
        ...
        step: 1,
        group: 'style',
        applicableTo: ['rectangle', 'diamond', 'capsule', 'speechBubble', 'browserWindow', 'mobilePhone', 'ghostButton', 'inputField', 'solidButton', 'dropdown', 'card', 'searchBar', 'badge', 'tooltip', 'dfdProcess', 'isometricCube', 'cylinder', 'stateSync', 'activationBar', 'externalEntity'],
        defaultValue: 0
    },
    {
        key: 'drawInnerBorder',
