import { s as o, b as m, d as b, f as a, z as W, w as z, x as U, y as B } from "./index-CcNfX7W9.js";
...
function Z() {
  ...
  return {
    ...
    playAnim: (n, t) => {
      n?.alive && import("./index-CcNfX7W9.js").then((r) => r.ao).then((r) => r.sequenceAnimator.playAnimation(n.id, { id: `bhv-${Date.now()}`, type: "preset", name: t, trigger: "programmatic" }, () => {
      }));
    },
    goToPage: (n) => {
    ...
    sound: (n) => {
      import("./index-CcNfX7W9.js").then((t) => t.ap).then((t) => t.playSfx(n));
    },
    music: (n) => {
      import("./index-CcNfX7W9.js").then((t) => t.ap).then((t) => n ? t.startMusic() : t.stopMusic());
    },
    end: (n) => {
      if (P(!0), n) {
...
function p() {
  if (y !== null && (cancelAnimationFrame(y), y = null), window.removeEventListener("keydown", K, !0), window.removeEventListener("keyup", O, !0), import("./index-CcNfX7W9.js").then((e) => e.ap).then((e) => e.stopMusic()), h.clear(), w = [], x.length = 0, v.length = 0, g) {
    const e = g;
    g = null, b(() => {
