...
<div id="stage"></div>
<script type="module">
  import { Yappy, mount } from 'https://cdn.jsdelivr.net/gh/algorisys-oss/yappydraw@v0.8.259/cdn/yappy.js'
...
Pin a version tag (`@v0.8.259`) in production. Tags are never moved, so a pinned URL
